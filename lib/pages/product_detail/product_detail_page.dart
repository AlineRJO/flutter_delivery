...
class ProductDetailPage extends StatefulWidget {
  ...
  const ProductDetailPage({Key? key, required this.product, this.order}) : super(key: key);
...
class _ProductDetailPageState
  ...
  void _showConfirmDelete(int amount) {
    showDialog(
      context: context,
      barrierDismissible: false, // TODO: desabilita ao clicar fora do dialog
      builder: (context) {
      return AlertDialog(
          ...
          Expanded(
            child: Padding(
              padding: const EdgeInsets.symmetric(
                  horizontal:
                      10), // TODO: coloca espacamento na esquerda e direita
                  ...
                  child: BlocBuilder<ProductDetailController, int>(
                    ...
                    builder: (context, amount) {
                      return ElevatedButton(
                        style: amount == 0 ? ElevatedButton.styleFrom(
